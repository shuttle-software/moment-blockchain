...
const PERMIT_TYPEHASH = keccak256(
  toUtf8Bytes('Permit(address holder, string memory _url, string memory _meta_url, uint256 nonce, uint256 expiry)')
)
      ...
      [
        ...
        keccak256(
          defaultAbiCoder.encode(
            ['bytes32', 'address', 'string', 'string', 'uint256', 'uint256'],
            [PERMIT_TYPEHASH, approve.owner, approve.url, approve.meta_url, nonce, deadline]
          )
        ),
      ]
    )
